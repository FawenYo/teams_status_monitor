...
*/}}
{{- define "teams-status-monitor.name" -}}
...
*/}}
{{- define "teams-status-monitor.fullname" -}}
...
*/}}
{{- define "teams-status-monitor.chart" -}}
...
*/}}
{{- define "teams-status-monitor.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "teams-status-monitor.fullname" .) .Values.serviceAccount.name }}
{{- else }}
